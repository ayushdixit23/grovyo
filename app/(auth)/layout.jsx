...
export default function UserLayout({ children }) {
  ...
  const slides = [
    {
      msg: "Build, Engage, Earn: A Step-by-Step Guide to Build Your Thriving Grovyo Community",
      img: login1,
    },
    {
      msg: "Build, Engage, Earn: A Step-by-Step Guide to Build Your Thriving Grovyo Community",
  ...
  return (
    <div className="h-screen w-screen dark:bg-loginbg dark:bg-cover dark:bg-center bg-lightlogin bg-no-repeat  dark:bg-[#131619] flex flex-row-reverse pn:max-sm:flex-col">
              ...
              >
                ...
                <div className="flex justify-center items-center">
                  <Image
                    ...
                    src={slide.img}
                    alt="hlo"
                    className={` ${index === 0 ? "relative -left-12" : ""} ${
                      index === 2 ? "max-w-[400px]" : "max-w-[600px]"
                    }`}
                  />
                </div>
              </div>
      ...
      <div className="w-[50%] h-[100%]  pn:max-sm:w-[100%] ">{children}</div>
      <div className="flex absolute pn:max-sm:hidden bottom-0 sm:bottom-2 w-[100%] flex-wrap md:justify-end justify-start items-center dark:text-white text-[#414141] gap-4 text-[12px] select-none">
